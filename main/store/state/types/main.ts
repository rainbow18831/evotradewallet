...
const PreferencesSchema = {
  launch: z.boolean().default(false).describe('Launch EvoTradeWallet on system start'),
  reveal: z.boolean().default(false).describe('Show EvoTradeWallet when user glides mouse to edge of screen'),
  autohide: z.boolean().default(false).describe('Automatically hide EvoTradeWallet when it loses focus'),
  accountCloseLock: z
    .boolean()
    .default(false)
