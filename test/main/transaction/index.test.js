...
describe('#populate', () => {
  ...
  describe('legacy transactions', () => {
    ...
    it('uses EvoTradeWallet-supplied gasPrice when the dapp did not specify a value', () => {
    ...
    it('uses EvoTradeWallet-supplied gasPrice when the dapp specified an invalid value', () => {
      gas.price.levels.fast = addHexPrefix((7e9).toString(16))
      rawTx.gasPrice = ''
      const tx = populate(rawTx, chainConfig, gas)
  ...
  describe('eip-1559 transactions', () => {
    ...
    it('uses EvoTradeWallet-supplied maxPriorityFeePerGas when the dapp did not specify a value', () => {
      gas.price.fees.maxPriorityFeePerGas = addHexPrefix((3e9).toString(16))
      const tx = populate(rawTx, chainConfig, gas)
    ...
    it('uses EvoTradeWallet-supplied maxPriorityFeePerGas when the dapp specified an invalid value', () => {
      gas.price.fees.maxPriorityFeePerGas = addHexPrefix((3e9).toString(16))
      rawTx.maxFeePerGas = ''
      const tx = populate(rawTx, chainConfig, gas)
