      ...
      <div className='notifyBoxWrap' onMouseDown={(e) => e.stopPropagation()}>
        <div className='notifyBoxSlide'>
          <div className='notifyBox'>
            ...
            <div className='notifyTitle'>EvoTradeWallet v0.1-beta</div>
            <div className='notifyBody'>
              <div className='notifyBodyBlock notifyBodyBlockBig'>
                We are excited to welcome you to the next iteration of EvoTradeWallet!
              </div>
              <div className='notifyBodyBlock'>
                Be advised, this version of EvoTradeWallet is currently in &quot;beta&quot; and will update on a beta
                track
              </div>
              <div className='notifyBodyBlock'>
              ...
              <div className='notifyBodyBlock'>
                <span>
                  Read our license and use EvoTradeWallet at your own risk</span>
              </div>
              <div className='notifyBodyBlock notifyBodyBlockBig'>
