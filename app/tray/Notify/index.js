...
import frameIcon from '../../../asset/icon.png'
    ...
    return (
      <div className='notifyBoxWrap' onMouseDown={(e) => e.stopPropagation()}>
        <div className='notifyBox'>
          ...
          <div className='notifyTitle'>Welcome to EvoTradeWallet!</div>
          <div className='notifySubtitle'>System-wide web3</div>
          <div className='notifyBody'>
            <div className='notifyBodyLine'>
              Please read{' '} our license, use at your own risk and verify transactions and account details on a signing device whenever
              possible.
            </div>
          </div>
      ...
      <div className='notifyBoxWrap' onMouseDown={(e) => e.stopPropagation()}>
        <div className='notifyBoxSlide'>
          <div className='notifyBox'>
            ...
            <div className='notifyTitle'>EvoTradeWallet v0.1</div>
            <div className='notifyBody'>
              <div className='notifyBodyBlock'>
                ...
                <div className='notifySection'>
                  ...
                  <span>and use EvoTradeWallet at your own risk</span>
                </div>
                <div className='notifySection'>
    ...
    return (
      ...
      >
        <div className='notifyBox'>
          ...
          <div className='notifyBody'>
            <div className='notifyBodyLine'>
            EvoTradeWallet hot signers are in alpha! Do not use them with high value accounts and verify your backups
    ...
    return (
      ...
      >
        <div className='notifyBox'>
          ...
          <div className='notifyBody'>
            <div className='notifyBodyLine'>
              The unlocked hot signer did not match the address shown in EvoTradeWallet and has been relocked.
            </div>
          </div>
          <div className='notifyInput'>
            <div
      ...
      <div className='notifyBoxWrap' onMouseDown={(e) => e.stopPropagation()}>
        <div className='notifyBox'>
          ...
          {hash ? (
            <div className='notifyBody'>
              <div className='notifyBodyLine'>
                {'EvoTradeWallet will open a block explorer in your browser for transaction:'}
              </div>
              <div className='notifyBodyHash'>{hash}</div>
            </div>
          ) : (
            <div className='notifyBody'>
              <div className='notifyBodyLine'>{`EvoTradeWallet will open the ${chainName}`}</div>
