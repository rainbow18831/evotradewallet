                ...
                <ClusterValue>
                  <NotifyMain>
                    <div style={{ paddingBottom: '24px' }}>
                      {`A new ${browserName} extension is attempting to connect as "EvoTrade Companion"`}{' '}
                    </div>
                    <div>{`If you did not recently add EvoTrade Companion please verify the extension origin below`}</div>
                  </NotifyMain>
                </ClusterValue>
              </ClusterRow>
              <ClusterRow>
